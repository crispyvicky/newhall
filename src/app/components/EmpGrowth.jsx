    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 w-full">
        ...
        >
          ...
          <p className="text-2xl sm:text-3xl font-extrabold uppercase tracking-widest bg-gradient-to-r from-[#956D13] via-[#FFD87C] to-[#A47A1E] bg-clip-text text-transparent font-[Poppins] px-4 py-1 whitespace-nowrap">
            VAMSHI KRISHNA
          </p>
        </motion.div>
      </div>
